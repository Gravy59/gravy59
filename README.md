...
- [scp-db](https://github.com/Gravy59/scp-db): A curation of [SCPs](https://scp-wiki.wikidot.com) using [Tailwind CSS](https://tailwindcss.com) and [Next.js](https://nextjs.org)
